      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8">
          <aside className="space-y-8">
                ...
                <li className="text-sm text-gray-600">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p>Técnico superior de desarrollo de aplicaciones web</p>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-medium text-indigo-700">Otros:</h3>
              <ul className="space-y-1">
                {[
          ...
          <main className="space-y-8">
            <div className="space-y-1">
              <h1 className="text-5xl font-bold text-indigo-600">Suleiman</h1>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    ...
                    web para la gestión de datos medioambientales. Estoy
                    utilizando tecnologías como React, Tailwind/MaterialUI,
                    Symfony y SQL.
                  </p>
                  <ul className="space-y-2">
                    {[
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    ...
                    crud de facturacion en una base de datos con PHP SQL y
                    Tailwind.
                  </p>
                  <ul className="space-y-2">
                    {[
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-medium">
                      <span className="text-indigo-600">Centro FP Llefia</span>{" "}
                      — Técnico de sistemas
                    </h3>
                    <span className="text-sm text-gray-500">
                  ...
                  <p className="text-gray-600">
                    ...
                    software y hardware de los ordenadores del centro.
                  </p>
                  <ul className="space-y-2">
                    {[
